...
const ConfirmBooking = (props: Props) => {
  ...
  const Steps = [
    <AddressStep AddressChange={AddressChange}/>,
    <TimeSlotSteps AdrsTrigger={AddressTrigger} setAddressTrigger={setAddressTrigger}/>,
        ...
        <div className='flex items-center justify-center px-4 mb-5'>
          <div className='flex items-center'>
            ...
            <div className='flex flex-col justify-center items-center space-y-1'>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="text-black size-8">
            ...
            <div className='flex flex-col justify-center items-center space-y-1'>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={`${CurrentStep>0?"text-black":"text-gray-400"} size-8`}>
            ...
            <div className='flex flex-col justify-center items-center space-y-1'>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={`${CurrentStep>1?"text-black":"text-gray-400"} size-8`}>
        ...
        <div className='flex flex-row space-y-0 space-x-5  justify-center'>
          ...
          <div className='space-y-5 w-full md:w-3/4'>
            ...
            <div className='w-full bg-white text-black p-5 md:p-7 rounded-md border border-gray-300 shadow-lg'>
              ...
              <TimeSlotSteps setAddressTrigger={setAddressTrigger} AdrsTrigger={AddressTrigger}/>
            </div>
